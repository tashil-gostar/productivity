...
def get_video_url_data(video_url, autoplay=False, loop=False, hide_controls=False, hide_fullscreen=False,
    ...
    if platform == 'aparat':
        return {
            'platform': platform,
            'embed_url': f'//www.aparat.com/video/video/embed/videohash/{video_id}/vt/frame',
            'video_id': video_id
        }

    return get_video_url_data_super(video_url, autoplay, loop, hide_controls, hide_fullscreen,
